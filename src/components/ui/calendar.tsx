...
type CustomComponents = NonNullable<DropdownProps["components"]> & {
  IconLeft: React.ComponentType<{ props?: React.HTMLAttributes<HTMLElement> }>;
  IconRight: React.ComponentType<{ props?: React.HTMLAttributes<HTMLElement> }>;
}
