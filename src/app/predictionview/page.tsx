            ...
            <div className="bg-white rounded-lg shadow-md">
              <Tabs defaultValue="stats" className="w-full">
                ...
                <TabsContent value="stats" className="space-y-4 p-4">
                  ...
                  REFERENCE FOR SETTLEMENT (Source of Truth): 1. The scorecard on the mentioned Source of truth will be considered for settlement. The score on the live streaming will not be taken into consideration 2. The scorecard displayed on the Platform alongwith the one liner is only indicative and used for reference purposes only and shall not be relied upon as a source of truth at the time of settlement of the Event. 3. Any decision by the match officials will be final and binding, For example- a 5-ball over will be considered as a complete over if given by the umpire. EXPIRY: The event will expire at the end of the match. In case of rain/bad light/bad weather/any other interruption: 1. The event will be expired/made inactive/paused for trading for the delayed time & will be activated when the play resumes 2. If the required number of overs (As per the tournament rules, if not mentioned then the required number of overs as per the MCC Rulebook) have been bowled in the 2nd innings for a result to come in the match, the event will remain active. 3. If the match is washed out/cancelled/postponed, all trades will be rendered null and your investment will be returned. SETTLEMENT: The event will settle at YES if the specified team: 1. Wins the match 2. Wins the match after Super Over/Super Overs 3. Wins the match by DLS method 4. Wins the match by VJD method 5. Wins the match by forfeit 6. Is awarded with the match 7. Wins by any other method as per the tournament rules Else the event will settle at NO if the specificed team: 1. . The specified team loses the match 2. The specified team loses the match by DLS method 3. The specified team loses the match by VJD method 4. The specified team loses the match after Super Over/Super Overs 5. The match ends in a draw 6. The match ends in a tie (even by DLS or VJD method) 7. The specified team forfeits the match 8. The specified team awards the match to the other team 9. The specified team Loses by any other method as per the tournament rules
                  </p>
                </TabsContent>
